...
public class ATM {
	...
	public static void Admin() {
		...
		while (i != 0) {
			...
			case 1:
				...
				System.out.println();
				System.out.print("Enter the count 500 : ");
				money[1] += sc.nextInt() * 500;
				System.out.println();
				System.out.print("Enter the count 200 : ");
				money[2] += sc.nextInt() * 200;
				System.out.println();
				System.out.print("Enter the count 100 : ");
	...
	public static void Width_draw(int Widthdraw_Amount) {
		...
		if (enteramount <= atm[Current_User].User_Balance && enteramount <= (money[0] + money[1] + money[2] + money[3])) {
			...
			if (count == 4) {
				...
				for(int i = 0; i < 4; i++) {
				   System.out.print(notesname[i] + "-->" + money[i]);
				}
				System.out.println();
			}
		}
	...
	public static void main(String[] args) {
	   ...
	   if (State == 1) {
		  atm = new ATM[2];
		  atm[0] = new ATM("Ram", "1234", 5000);
		  atm[0].User_Statement = new ArrayList<>();
		  atm[1] = new ATM("Ramu","6789", 6000);
